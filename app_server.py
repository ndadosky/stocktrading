...
@media(max-width:720px){.home-grid{grid-template-columns:1fr}.cars-card,.solar{grid-column:auto}.cars-grid{grid-template-columns:1fr}.solar-layout{grid-template-columns:1fr;gap:22px}.page-title{align-items:flex-start;flex-direction:column}.home-card{padding:18px}.hero-value{font-size:40px}.stepper{width:100%;margin-right:0}.control-row>.control-btn{flex:1}}
