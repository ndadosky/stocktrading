        ...
        try:
            ...
            if result:
                ...
                result.update({
                    ...
                    "catalyst_mode": source.get("catalyst_mode", "SHADOW"),
                    "catalyst_configured": source.get("catalyst_configured", False),
                    "news_count_72h": source.get("news_count_72h", 0),
                    "catalyst_positive_count": source.get("catalyst_positive_count", 0),
                    "catalyst_risk_count": source.get("catalyst_risk_count", 0),
                    "catalyst_shadow_score": source.get("catalyst_shadow_score", 0),
                    "catalyst_flags": source.get("catalyst_flags", ""),
                    "latest_headline": source.get("latest_headline", ""),
                    "latest_news_url": source.get("latest_news_url", ""),
